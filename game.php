...
<body>
    ...
    <form method="POST">
        ...
        <label for="celebrate">Enter a celebration:</label>
        <input type="text" id="celebrate" name="celebrate" required>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $celebrate = htmlspecialchars($_POST['celebrate']);

        echo "<div class='result'>";
        echo "Once upon a time, in a <strong>$color</strong> forest, there were magical <strong>$pluralNoun</strong>. ";
        echo "They loved to dance and sing during <strong>$celebrate</strong>. It was the funniest celebration ever!";
        echo "</div>";
    }
    ?>
    </div>
